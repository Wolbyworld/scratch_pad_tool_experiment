#!/usr/bin/env python3
"""
Function Calling Tools for Luzia - Refactored Architecture

Contains functions that GPT-4.1 can call to enrich conversation context
with scratch pad information, media analysis, and mathematical operations.

This file now uses a clean, refactored architecture with separate tool classes
